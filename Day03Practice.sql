/*Child tabloda on delete cascade komutu yazilmasa
...
2-) Child tablodaki veri silinmeden Parent tablodaki veri silinmeye calisildiginda pg admin Error verir.
...
parent tablodaki veriler rahatca silinebilir. Ama parentla birlikte Child da gider.
*/
...
-- SORU3: vergi_no’su 201 olan toptancinin sirket_ismi'ni 'nokia' ve irtibat_ismi’ni 'Canan Can' olarak güncelleyiniz.
UPDATE toptancilar SET sirket_ismi = 'nokia', irtibat_ismi= 'Canan Can' WHERE vergi_no=201;

select * from toptancilar;

-- SORU4: sirket_ismi nokia olan toptancinin irtibat_ismi'ni 'Bilal Han' olarak güncelleyiniz.
...
-- SORU8: Malzemeler tablosundaki musteri_isim'i Ali Can olan malzeme_isim'ini,toptancılar  tablosunda irtibat_ismi 'Adem Coş' olan sirket_ismi ile güncelleyiniz.
...
UPDATE toptancilar SET irtibat_ismi= 'Cetin Hos' WHERE irtibat_ismi= 'Çetin Hoş';
UPDATE toptancilar SET irtibat_ismi= 'Adem Cos' WHERE irtibat_ismi= 'Adem Coş';
UPDATE toptancilar SET irtibat_ismi= 'Mehmet Gor' WHERE irtibat_ismi= 'Mehmet Gör';
UPDATE toptancilar SET irtibat_ismi= 'Kadir Sen' WHERE irtibat_ismi= 'Kadir Şen';
UPDATE malzemeler SET musteri_isim= 'Ramiz Ozmen' WHERE musteri_isim= 'Ramiz Özmen';

-- SORU9: malzeme_ismi Laptop olan musteri_isim'ini, sirket_ismi Apple’in irtibat_isim'i ile güncelleyiniz.
